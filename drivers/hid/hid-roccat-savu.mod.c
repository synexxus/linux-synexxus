...
__attribute__((section("__versions"))) = {
	...
	{ 0x1571fad1, __VMLINUX_SYMBOL_STR(roccat_common2_sysfs_read) },
	{ 0x95765835, __VMLINUX_SYMBOL_STR(roccat_common2_sysfs_write) },
	{ 0x2f710f94, __VMLINUX_SYMBOL_STR(roccat_connect) },
	{ 0x8957d6c4, __VMLINUX_SYMBOL_STR(roccat_common2_device_init_struct) },
