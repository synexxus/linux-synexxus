...
static int adv7604_init_default_hdmi(void)
{
	...
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_PRIMARY_MODE, 0x06);	// HDMI-GR mode
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_VIDEO_STANDARD, adv7604_prim_mode_hdmi_gr[adv7604_hdmi_mode_SVGA_60].vid_std);	// HDMI GR mode (800x600 @60)
...
static int adv7604_init_default_gr(void)
{
	...
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_VIDEO_STANDARD, adv7604_prim_mode_gr[adv7604_gr_mode_SVGA_60].vid_std);	// NTSC Comp
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_PRIMARY_MODE, 
...
//	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_PRIMARY_MODE, 0x02);	// Graphics-RGB mode
//	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_VIDEO_STANDARD, adv7604_prim_mode_gr[adv7604_gr_mode_SVGA_60].vid_std);	// HDMI GR mode (800x600 @60)
...
static int adv7604_init_default_comp(void)
{
	...
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_DEFAULT_AFE_SLAVE_ADDRESS, 0x00, 0x08);	/* Powerup ADC */
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_DEFAULT_AFE_SLAVE_ADDRESS, 0x01, 0x06);	/* Power up AFE */
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_DEFAULT_AFE_SLAVE_ADDRESS, 0x02, 0x01);	/* Select the AIN_SEL[2:0] 4, 5, 6.  We want ch2 or ch3*/
	...
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_VIDEO_STANDARD, adv7604_prim_mode_comp[adv7604_comp_mode_PR_2x1_525p].vid_std);	// NTSC Comp
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_PRIMARY_MODE, 
	...
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_IO_REG_02, 0xFF);	/* */
	//adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_IO_REG_02, 0x80);	/* 16-bit ITU-656 mode*/
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_IO_REG_02, 0x00);	/* 8-bit ITU-656 mode*/
	adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_IO_REG_15, 0xB0); /* Video output available */
...
static int adv7604_change_video_mode(int new_mode){
	...
	u8 modeval = (adv7604_data.curr_vid_std[new_mode].vid_std & ADV7604_MASK_VID_STD);			// Setup Mode value
		ret=adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_VIDEO_STANDARD, modeval);
		modeval = 0x00 | 
		...
		ret=adv7604_generic_i2c_byte_write(adv7604_data.i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_PRIMARY_MODE, modeval);
			    ...
			    enum adv7604_mode mode)
{
	...
	if (frame_rate > MAX_FPS || frame_rate < MIN_FPS) {
		pr_err("Unsupported V_FREQ mode for current resolution detected!\n");
		return -1;
	}

	//curr_vid_std = (adv7604_generic_i2c_byte_read(sensor->i2c_client, ADV7604_IO_MAP_I2C_ADDR, 0x00) & ADV7604_MASK_VID_STD);
	curr_v_freq = adv7604_generic_i2c_byte_read(sensor->i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_PRIMARY_MODE);
	...
	adv7604_generic_i2c_byte_write(sensor->i2c_client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_PRIMARY_MODE, reg_val);
	return retval;
}
...
static int ioctl_g_fmt_cap(struct v4l2_int_device *s, struct v4l2_format *f)
{
	...
	dev_dbg(&adv7604_data.i2c_client->dev, "adv7604:ioctl_g_fmt_cap\n");
...
static int ioctl_s_fmt_cap(struct v4l2_int_device *s, struct v4l2_format *f)
{
	...
	dev_dbg(&adv7604_data.i2c_client->dev, "adv7604:ioctl_s_fmt_cap\n");
...
static int ioctl_g_chip_ident(struct v4l2_int_device *s, int *id)
{
	...
	strcpy(((struct v4l2_dbg_chip_ident *)id)->match.name, "adv7604");
...
static int ioctl_dev_init(struct v4l2_int_device *s)
{
	...
	printk(KERN_INFO "mxc_v4l2_adv7604: ioctl_dev_init attaching to master?\n");
...
static s32 adv7604_generic_i2c_byte_read(struct i2c_client *client, u8 addr, u8 reg){
	...
	if (2 != i2c_master_send(client, au8RegBuf, 1)) {
			 ...
			 const struct i2c_device_id *id)
{
	...
	printk(KERN_INFO "adv7604_probe\n");
...
//	adv7604_data.streamcap.capability = V4L2_MODE_HIGHQUALITY |
	...
	val = adv7604_generic_i2c_byte_read(client, ADV7604_IO_MAP_I2C_ADDR, ADV7604_REG_HDMI_SLAVE_ADDRESS);
	if(val != ADV7604_DEFAULT_HDMI_SLAVE_ADDRESS) {
	...
	pr_info("Decoder adv7604 found\n");

	return retval;

	pr_info("error initializing adv7604 driver\n");
	return -ENODEV;
}
...
static struct i2c_driver mxc_v4l2_adv7604_i2c_driver = {
	.driver = {
		   .owner = THIS_MODULE,
		   .name = "mxc_v4l2_adv7604",
		   },
...
static int mxc_v4l2_adv7604_i2c_init(void)
{
	...
	err = i2c_add_driver(&mxc_v4l2_adv7604_i2c_driver);
	if (err != 0)
...
static void mxc_v4l2_adv7604_i2c_clean(void)
{
	...
	i2c_del_driver(&mxc_v4l2_adv7604_i2c_driver);
}
