...
static s32 PIV7D9008_generic_i2c_byte_read(struct i2c_client *client, u8 addr, u8 reg){
...
static s32 PIV7D9008_i2c_byte_read(struct i2c_client *client, u8 reg){
	u8 au8RegBuf[1] = {0};
	u8 u8RdVal = 0;
	int retval = 0;
	au8RegBuf[0] = reg;
...
static s32 PIV7D9008_generic_i2c_byte_write(struct i2c_client *client, u8 addr, u8 reg, u8 val){
	unsigned short temp_addr = client->addr;		// Save the address for restoration later
	u8 au8Buf[2] = {0};
	int retval = 0;
	au8Buf[0] = reg;
...
static s32 PIV7D9008_i2c_byte_write(struct i2c_client *client, u8 reg, u8 val){
	u8 au8Buf[2] = {0};
	int retval = 0;
	au8Buf[0] = reg;
	au8Buf[1] = val;
