...
//	static int pwn_gpio;
	 ...
	 */
	#define ADV7604_IO_MAP_I2C_ADDR					0x40

	#define	ADV7604_REG_AVLINK_SLAVE_ADDRESS		0xF3
	#define	ADV7604_DEFAULT_AVLINK_SLAVE_ADDRESS			0x84

	#define	ADV7604_REG_CEC_SLAVE_ADDRESS			0xF4
	#define	ADV7604_DEFAULT_CEC_SLAVE_ADDRESS			0x80

	#define	ADV7604_REG_INFOFRAME_SLAVE_ADDRESS		0xF5
	#define	ADV7604_DEFAULT_INFOFRAME_SLAVE_ADDRESS			0x7C

	#define	ADV7604_REG_ESDP_SLAVE_ADDRESS			0xF6
	#define	ADV7604_DEFAULT_ESDP_SLAVE_ADDRESS			0x70

	#define	ADV7604_REG_DPP_SLAVE_ADDRESS			0xF7
	#define	ADV7604_DEFAULT_DPP_SLAVE_ADDRESS			0x78

	#define	ADV7604_REG_AFE_SLAVE_ADDRESS			0xF8
	#define	ADV7604_DEFAULT_AFE_SLAVE_ADDRESS			0x4C

	#define	ADV7604_REG_KSV_SLAVE_ADDRESS			0xF9
	#define	ADV7604_DEFAULT_KSV_SLAVE_ADDRESS			0x64

	#define	ADV7604_REG_EDID_SLAVE_ADDRESS			0xFA
	#define	ADV7604_DEFAULT_EDID_SLAVE_ADDRESS			0x6C

	#define	ADV7604_REG_HDMI_SLAVE_ADDRESS			0xFB
	#define	ADV7604_DEFAULT_HDMI_SLAVE_ADDRESS			0x68

	#define	ADV7604_REG_TEST_SLAVE_ADDRESS			0xFC
	#define	ADV7604_DEFAULT_TEST_SLAVE_ADDRESS			0x60

	#define	ADV7604_REG_CP_SLAVE_ADDRESS			0xFD
	#define	ADV7604_DEFAULT_CP_SLAVE_ADDRESS			0x44

	#define	ADV7604_REG_VDP_SLAVE_ADDRESS			0xFE
	#define	ADV7604_DEFAULT_VDP_SLAVE_ADDRESS			0x48
