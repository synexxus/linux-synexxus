...
__attribute__((section("__versions"))) = {
	...
	{ 0x38934a6f, __VMLINUX_SYMBOL_STR(usb_function_deactivate) },
	...
	{ 0xf493f70, __VMLINUX_SYMBOL_STR(usb_function_activate) },
...
MODULE_INFO(srcversion, "F6DD9E0D9B68FC37A224A11");
