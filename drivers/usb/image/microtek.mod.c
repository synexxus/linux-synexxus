...
__attribute__((section("__versions"))) = {
	...
	{ 0xde6fd10b, __VMLINUX_SYMBOL_STR(scsi_scan_host) },
	...
	{ 0xcb21d1ce, __VMLINUX_SYMBOL_STR(scsi_cmd_get_serial) },
	...
	{ 0x9032bc3c, __VMLINUX_SYMBOL_STR(blk_queue_dma_alignment) },
