	...
	if (!IS_ERR(gpr)) {
		if (of_machine_is_compatible("fsl,imx6q-sabresd") ||
			...
			regmap_update_bits(gpr, IOMUXC_GPR13, 0x3F, 0x0C);
		     ...
		     regmap_update_bits(gpr, IOMUXC_GPR1, 3 << 19, 3 << 19);	// Enable IPU1 CSI 0 Parallel Interface & IPU2 CSI1
			//regmap_update_bits(gpr, IOMUXC_GPR1, 1 << 20, 1 << 20);	// Enable IPU2 CSI 1 Parlalel Interface
		      pr_info("\t Enabled Support for IPU2 CSI 1\n");
		}
	} else {
